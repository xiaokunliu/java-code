...
public class LogAspect {
    ...
    // 注解声明切点
    @Pointcut("@annotation(com.xiaokunliu.study.springboot_j2ee.spring.config.aop.Action)")
    ...
    @Before("execution(* com.xiaokunliu.study.springboot_j2ee.spring.config.aop.AopService.*(..))")
