package com.xiaokunliu.interview.j2ee.jpa.entity;

import com.xiaokunliu.interview.j2ee.jpa.extend_relations.Address;

import javax.persistence.*;

/**
 * 抽象实体类 JPA仍然可以对查询出来的抽象实体类进行CRUD操作并保存到数据库中
