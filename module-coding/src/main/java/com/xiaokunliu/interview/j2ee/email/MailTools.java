...
public final class MailTools {
    ...
    public String transferChinese(String textString) {
        try {
            return MimeUtility.encodeText(new String(textString.getBytes(), StandardCharsets.UTF_8), "GBK2312", "B");
    ...
    private boolean isGmail(String accountEmail) {
        return StringUtils.isNotBlank(accountEmail) && accountEmail.lastIndexOf("@gmail.com") != -1;
    }
