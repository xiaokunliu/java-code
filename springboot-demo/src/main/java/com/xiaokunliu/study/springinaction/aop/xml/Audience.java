...
public class Audience {
     ...
     */
//    @Before("execution(* com.xiaokunliu.study.springinaction.aop.xml.Performance.perform(..))")
...
//    @AfterReturning("execution(* com.xiaokunliu.study.springinaction.aop.xml.Performance.perform(..))")
    public void applause(){
        System.out.println("applause ...");
    }

//    @AfterThrowing("execution(* com.xiaokunliu.study.springinaction.aop.xml.Performance.perform(..))")
...
//    @Pointcut("execution(* com.xiaokunliu.study.springinaction.aop.xml.Performance.perform(..))")
    public void perform(){
        // 方法内容并不重要，只是作为注解的附体
    }
...
//    @DeclareParents(value = "com.xiaokunliu.study.springinaction.aop.xml.Performance+",
