package com.xiaokunliu.payment.alipay.modules.unionpay.util;
...
public class CertUtil {
    ...
    private static void initEncryptCert() {
        ...
        if (StringUtils.isNotBlank(SDKConfig.getConfig().getEncryptCertPath())) {
        ...
        if (StringUtils.isNotBlank(SDKConfig.getConfig().getEncryptTrackCertPath())) {
    ...
    private static void initTrackKey() {
        if (StringUtils.isNotBlank(SDKConfig.getConfig().getEncryptTrackKeyModulus())
                && !StringUtils.isNotBlank(SDKConfig.getConfig().getEncryptTrackKeyExponent())) {
